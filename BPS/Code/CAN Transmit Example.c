/*
 This is example code for a TRANSMITTING node
...
//       int1 ext - TRUE to use an extended ID, FALSE if not
//       int 1rtr - TRUE to set the RTR (request) bit in the ID, false if NOT
//
//    Returns:
...
void main() {
   ...
   unsigned int8 out_data[8] = {0,100,200,3,4,5,6,7};
   int32 tx_id = 0x002;
   int1 tx_rtr = 0;
   int1 tx_ext = 0;
   int tx_len = 8;
